...
X = data.drop(['FCVC','NCP','CAEC','SMOKE','TUE','CALC','MTRANS','NObeyesdad','SCC', 'CH2O', 'FAF'], axis= 1)
y = data['NObeyesdad']

# Convertir variables categóricas a variables dummy
X = pd.get_dummies(X, columns=['Gender', 'family_history_with_overweight', 'FAVC'])
...
# Guardar el modelo
joblib.dump(logistic_classifier, 'modelo_regresion_logistica_prueba2.joblib')
